...
public class Permutation extends Fragment
{
    ...
    {
        rootView = inflater.inflate(R.layout.fragment_permutation, container, false);

        toggle = (Switch) rootView.findViewById(R.id.permutation_switch);
    ...
    private class Calculate extends AsyncTask<Boolean, Void, String>
    {
        ...
        protected String doInBackground(Boolean... params)
        {
            ...
            String result;
            if (flag)
                result = Combinatorics.permutationWithRepetitions(Long.parseLong(set), Long.parseLong(subset));
            else
                result = Combinatorics.permutation(Long.parseLong(set), Long.parseLong(subset));
